...
- **Spacebar/Enter**: Confirm selections and actions
- **Mouse**: Click to interact with all elements
- **Number Keys 1-5**: (Video Poker) Hold/release cards

### Features
- Real-time balance tracking
- Payout tables for each game
- Special 40th anniversary messages and bonuses
- Milestone rewards for reaching balance targets
- Easy return to main menu from any game
